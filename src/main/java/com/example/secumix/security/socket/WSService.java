...
import com.example.secumix.security.notify.NotificationService;
...
public class WSService {
    ...
    @Autowired
    public WSService(SimpMessagingTemplate messagingTemplate, NotificationService2 notificationService) {
